...
function BusinessPage() {
    return (
        <div className='container pt-3'>
            ...
            <div className='pt-3'>
                <p>Somos una empresa tucumana dedicada a brindar servicios exequiales desde hace más de setenta años. Enrique Serra basa su filosofía en el respeto, la comprensión y una inmensa vocación de servicio.</p>
            ...
            <div className='pt-3'>
                ...
                <p>La continua capacitación que reciben, sumada a la gran experiencia acumulada a lo largo de siete décadas, se conjuga en un grupo humano que está preparado para realizar su tarea cuidando cada detalle.</p>
            </div>
